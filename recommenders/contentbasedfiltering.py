...
class CBFRecommender(Recommender):
    ...
    def __init__(self, URM, ICM, exclude_seen=True, topK=204, shrink=4.7, normalize=False, similarity="dice",
                 asymmetric_alpha=0.67, feature_weighting="BM25", K=39.3, B=0.80):
    ...
    def fit(self):
        self.ICM = apply_feature_weighting(self.ICM, self.feature_weighting, K=self.K, B=self.B, transpose=True)
